...
@section('pageTitle', __('Terms and Conditions | ' . config('app.name')))
@section('pageDescription', __('These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (you), and' . config('app.name') . '.'))

@section('content')
@include('web.includes.banner', ['bannerTitle' => "Terms and Conditions", 'bannerMaster' => "legal"])
    ...
    <div class="row">
      <div class="col-12 writing-content">
        ...
        <div>
          ...
          <p>1.1  These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (you), and {{ config('app.name') }}, located beside Heritage bank, Ekiti State University, Ado-Ekiti, Ekiti State, Nigeria (we, us), concerning your access to and use of the <span>{{ config('app.name') }}</span> (<a href="{{ config('app.url') }}" target="blank">{{ config('app.url') }}</a>) website as well as any related applications (the Site).</p>
          <p>The Site provides the following services: Bulk Airtime sales, Real Estate, Investment packages, Mobile/Internet Data subscriptions, and Cable TV subscriptions.  (Services). You agree that by accessing the Site and/or Services, you have read, understood, and agree to be bound by all of these Terms and Conditions</p>
          ...
          <p>1.7  Additional policies which also apply to your use of the Site include:
            <ol>
              <li>Our Privacy Notice <a href="{{ route('legal.privacy') }}" target="blank">{{ route('legal.privacy') }}</a>, which sets out the terms on which we process any personal data we collect from you, or that you provide to us. By using the Site, you consent to such processing and you warrant that all data provided by you is accurate.</li>
              <li>Our Cookie Policy <a href="{{ route('legal.cookie') }}" target="blank">{{ route('legal.cookie') }}</a>, which sets out information about the cookies on the Site.</li>
            </ol>
          </p>
        </div>
        ...
        <div>
          ...
          <p>2.1  Our Acceptable Use Policy, sets out all the permitted uses and prohibited uses of this site.</p>
        ...
        <div>
          ...
          <p>If you know or suspect that anyone other than you knows your user information (such as an identification code or user name) and/or password you must promptly notify us at <a href="mailto:techhubeksu@gmail.com" target="_blank">techhubeksu@gmail.com</a></p>
        ...
        <div>
          <h4>4. Our content</h4>
          <p>4.1  Unless otherwise indicated, the Site and Services including source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics on the Site (Our Content) are owned or licensed to us, and are protected by copyright and trade mark laws.</p>
        ...
        <div>
          <h4>5. Link to third party content </h4>
          <p>5.1  The Site may contain links to websites or applications operated by third parties.We do not have any influence or control over any such third party websites or applications or the third party operator. We are not responsible for and do not endorse any third party websites or applications or their availability or content.</p>
          <p>5.2  We accept no responsibility for adverts contained within the Site. If you agree to purchase goods and/or services from any third party who advertises in the Site, you do so at your own risk. The advertiser, and not us, is responsible for such goods and/or services and if you have any questions or complaints in relation to them, you should contact the advertiser.</p>
        </div>
        ...
        <div>
          ...
          <p>
            8.2  Our responsibility for loss or damage suffered by you:<br><br>Whether you are a consumer or a business user:
            <ul>
              ...
              <li>Notwithstanding anything to the contrary contained in the Disclaimer/Limitation of Liability section, our liability to you for any cause whatsoever and regardless of the form of the action, will at all times be limited to a total aggregate amount equal to the greater of (a) the sum of One Thousand Naira(₦1000) or (b) the amount paid, if any, by you to us for the Services/Site during the six (6) month period prior to any cause of action arising. Different limitations and exclusions of liability will apply to liability arising as a result of the supply of any products to you, which will be set out in our Terms and conditions of supply <a href="{{ config('app.url') }}/legal/supply" target="_blank">{{ config('app.url') }}/legal/supply</a>.</li>
            </ul>
        ...
        <div>
          ...
          <p>9.1  These Terms and Conditions shall remain in full force and effect while you use the Site or Services or are otherwise a user of the Site, as applicable. You may terminate your use or participation at any time, for any reason, by following the instructions for terminating user accounts in your account settings, if available, or by contacting us at <a href="mailto:techhubeksu@gmail.com" target="_blank">techhubeksu@gmail.com</a>.</p>
        ...
        <div>
          ...
          <p>10.8  Please note that these Terms and Conditions, their subject matter and their formation, are governed by English law. You and we both agree that the courts of Nigeria will have exclusive jurisdiction. If you have any complaint or wish to raise a dispute under these Terms and Conditions or otherwise in relation to the Site please send a mail to us at <a href="mailto:techhubeksu@gmail.com" target="_blank">techhubeksu@gmail.com</a></p>
          <p>10.9  A person who is not a party to these Terms and Conditions shall have no right under the Contracts (Rights of Third Parties) Act 1999 to enforce any term of these Terms and Conditions.</p>
          <p>10.10  In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us by email at <a href="mailto:info@techhubeksu.com" target="_blank">info@techhubeksu.com</a> or by post to:</p>
